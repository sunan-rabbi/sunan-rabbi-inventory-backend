...
const getAllAdmin = async (filters: IAdminFilterRequest, options: IPaginationOptions): Promise<IGenericResponse<Admin[]>> => {
...
const updateAdmin = async (id: string, payload: { name?: string, image?: string }, file: IUploadFile) => {
